   ...
   public static class SolicitudMantenimiento
    {
        ...
        public static object RegistrarSolicitud(Nullable<int> codigoSolicitud, string descripcion, string  @Fecha, Nullable<int> estado, Nullable<int> codigoSede, Nullable<int> codigoArea, Nullable<int> CodigoTipoMantenimiento, Nullable<int> CodigoEmpleado1 ,string  UsuarioRegistro, string  Accion)
        {
            ...
            using (var db = new EFData.PET_DBEntities())
            {
                ...
                //var result = db.USP_CONSULTA_SOLICITUDES(0,"pr",0,null,null,1,0,0).ToList()  ;
                int result = db.USP_REGISTRAR_SOLICITUD(codigoSolicitud, descripcion, Fecha, estado,codigoSede, codigoArea,
                                        CodigoTipoMantenimiento, CodigoEmpleado1, UsuarioRegistro, Accion, output) ;
                return output;
